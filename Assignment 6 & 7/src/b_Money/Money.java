...
public class Money implements Comparable {
	...
	public Money add(Money other) {
		int addedMoney = amount + currency.valueInThisCurrency(other.getAmount(),
				other.getCurrency());
		return new Money(addedMoney,currency);
	}
	...
	public Money sub(Money other) {
		int subtractedMoney = amount - currency.valueInThisCurrency(other.getAmount(),
				other.getCurrency());
		return new Money(subtractedMoney,currency);
	}
	...
	public Money negate() {
		...
		return new Money(negatedAmount,currency);
	}
	...
	public int compareTo(Object other) {
		...
		if (equals(money)){
			return 0;
		}else if(money.universalValue()>universalValue()){
			return -1;
		}else{
			return 1;
		}
